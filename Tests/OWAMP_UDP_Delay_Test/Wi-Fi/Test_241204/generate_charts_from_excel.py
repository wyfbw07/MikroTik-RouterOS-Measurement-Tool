...
file_path2 = pre_path+'10-2.xlsx'
file_path3 = pre_path+'15-2.xlsx'
file_path4 = pre_path+'20-2.xlsx'
file_path5 = pre_path+'25-2.xlsx'
...
measurements_data = data.parse('Set_2')
measurements_data2 = data2.parse('Set_2')
measurements_data3 = data3.parse('Set_2')
measurements_data4 = data4.parse('Set_2')
measurements_data5 = data5.parse('Set_2')
...
plt.plot(sequence_numbers, latency, label='10m', color=colors[0])
plt.plot(sequence_numbers2, latency2, label='20m', color=colors[1])
plt.plot(sequence_numbers3, latency3, label='30m', color=colors[2])
plt.plot(sequence_numbers4, latency4, label='40m', color=colors[3])
plt.plot(sequence_numbers5, latency5, label='50m', color=colors[4])
...
bin_num = 100
plt.figure(figsize=(10, 6))
plt.hist(latency, bins=bin_num, alpha=0.7, label='10m', color=colors[0])
plt.hist(latency2, bins=bin_num, alpha=0.7, label='20m', color=colors[1])
plt.hist(latency3, bins=bin_num, alpha=0.7, label='30m', color=colors[2])
plt.hist(latency4, bins=bin_num, alpha=0.7, label='40m', color=colors[3])
plt.hist(latency5, bins=bin_num, alpha=0.7, label='50m', color=colors[4])
